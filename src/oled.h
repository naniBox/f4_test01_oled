...
//-----------------------------------------------------------------------------
#ifndef _naniBox_f4_test01_oled_oled_H_
#define _naniBox_f4_test01_oled_oled_H_
...
#define OLED_BUFSIZE 			(OLED_WIDTH*OLED_HEIGHT/8) // div8 because each pixel is a bit
...
void OLED_drawFastVLine(OLEDDriver * od, int16_t x, int16_t y, int16_t h, uint16_t color);
void OLED_drawFastHLine(OLEDDriver * od, int16_t x, int16_t y, int16_t h, uint16_t color);
...
#endif // _naniBox_f4_test01_oled_oled_H_
